...
insertion. Note that you don't need to modify intervals in-place. You can make a
new array and return it. Time complexity: O(n) Additional memory: O(1) in good
case, O(n) in worst case Idea: iterate through intervals, merge all overlapping
intervals
*/
...
int main() {
  ...
  // std::vector<std::vector<int>> intervals = {{1, 2}, {3, 5}, {6, 7}, {8, 10},
  // {12, 16}}; std::vector<int> new_interval = {4, 8};
