...
Idea: use dynamic programming approach (in ways[i] store minimum coins needed to form number i)
*/
...
class Solution {
public:
    [[nodiscard]] static int coinChange(const std::vector<int>& coins, int amount) {
