...
Idea: use hashmap of prefix sums which was met on previous steps (key = sum, value = number of
prefix sums), k = curr_pref_sum - prev_prefix_sum, than prev_prefix_sum = curr_pref_sum - k;
*/
