...
segmentation. Time complexity: O(n ^ 3) Additional memory complexity: O(n) Idea:
use dynamic programming (answer can we construct s[0..i] substr on step i)
*/
...
class Solution {
public:
  [[nodiscard]] static bool wordBreak(const std::string& s,
