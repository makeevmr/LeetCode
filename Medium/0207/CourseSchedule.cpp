...
return false. Time complexity: O(V + E) Additional memory complexity: O(E) Idea:
use DFS algorithm to find cycle in graph
*/
...
private:
  ...
  static bool findCycleDFS(
    ...
    if (auto f_iter = adjacency_list.find(curr_node);
