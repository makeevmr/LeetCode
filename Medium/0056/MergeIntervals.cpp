...
cover all the intervals in the input. Time complexity: O(n * log(n)) Additional
memory complexity: O(log(n)) since sort uses QuickSort algorithm Idea: sort
intervals by left border, save current interval and if new interval overlaps
previous than merge them, push previous interval to answer otherwise
*/
...
int main() {
  // std::vector<std::vector<int>> intervals = {{1, 3}, {2, 6}, {8, 10}, {15,
  // 18}};
