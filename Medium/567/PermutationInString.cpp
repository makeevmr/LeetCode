...
Idea: use unordered_map to store frequencies of s1 string and frequencies of s2 substring, count
difference in hasmaps if difference == 0 than return true;
*/
...
public:
    bool checkInclusion(const std::string& s1, const std::string& s2) {
        ...
        int difference = 0;
        for (auto b_iter = s1_freq.begin(), e_iter = s1_freq.end(); b_iter != e_iter; ++b_iter) {
