...
values in the list's nodes, only nodes themselves may be changed. Time
complexity: O(n) Additional memory complexity: O(1) Idea: compute does curr_head
form group if it does, than reverse it
*/
