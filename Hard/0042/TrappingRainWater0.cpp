...
// complexity: O(n) Additional memory complexity: O(1) Idea: Use two pointers,
// the amount of water in the current column will be the difference between the
// current maximum and the current column
