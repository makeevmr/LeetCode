...
line. Time complexity: O(n ^ 3) Additional memory complexity: O(1) Idea: compute
all possible lines with O(n ^ 2), all points on each line with O(n)
*/
...
int main() {
  // std::vector<std::vector<int>> points = {{1, 1}, {3, 2}, {5, 3}, {4, 1}, {2,
  // 3}, {1, 4}};
