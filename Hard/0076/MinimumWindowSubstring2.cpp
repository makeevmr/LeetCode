...
// Idea: use Binary search for window size, for fixed window size use O(n) time to compute the
// answer (yes/no such window found)
...
private:
    static std::pair<int, int> getSubstr(const std::string &s, const std::string &t,
