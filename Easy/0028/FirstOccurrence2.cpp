...
// Time complexity: O(n * (n - k + 1)), where n is size of haystack, k is size
// of needle Additional memory complexity: O(1) Idea: for every possible window,
// which are n - k + 1, compute in O(n) is needle and window are equivalent
