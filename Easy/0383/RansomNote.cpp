...
// letter in magazine can only be used once in ransomNote. Time complexity: O(n
// + m), where n is size of ransomNote, m is sizeof magazine Additional memory
// complexity: O(power of alphabet) Idea: use unordered_map
...
class Solution {
public:
  static bool canConstruct(const std::string& ransomNote,
